...
void parse_net_options(list *options, network *net)
{
    ...
    *net->cuda_graph_ready = 0;
    ...
    net->motionBlurRate = option_find_float_quiet(options, "motionblur", 0);
    net->motionBlurX = option_find_int_quiet(options, "motionblurX", 0);
    net->motionBlurY = option_find_int_quiet(options, "motionblurY", 0);
